...
import { Link, ExternalLink, Menu, X, MapPin, Calendar, Newspaper, Store, Users, Clock, ChevronRight } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-[#1A1A1A] text-white">
      ...
      <header className="sticky top-0 z-50 bg-[#1A1A1A]/80 backdrop-blur-md">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <nav className="hidden md:flex items-center gap-8">
            ...
            <span className="cursor-not-allowed bg-[#6c63ff] hover:bg-[#5a52d5] px-4 py-2 rounded-full transition-colors">
              Coming Soon
            </span>
          </nav>
      ...
      >
        ...
        <div className="container mx-auto px-4 relative transform translate-x-0 md:translate-x-8">
          <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
            
            {/* Text block: centered on mobile, left-aligned on md+ */}
            <div className="w-full md:w-1/2 space-y-6 text-center md:text-left">
              ...
              <div className="pt-4">
                <span className="cursor-not-allowed inline-flex items-center gap-2 bg-[#6c63ff] hover:bg-[#5a52d5] px-6 py-3 rounded-full text-white font-medium transition-all transform hover:scale-105">
            ...
            <div className="hidden md:flex md:w-1/2 justify-center">
              <div className="relative">
                ...
                <div className="relative bg-[#252525]/80 p-6 rounded-2xl shadow-2xl backdrop-blur-sm border border-[#6c63ff]/20">
                  ...
                  />
                  <p className="text-center mt-4 mb-4 text-2xl font-bold text-[#6c63ff]">
                    LocalLinkk Coming Soon!
                  </p>
      ...
      <section className="py-16 bg-[#6c63ff]/10">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="pt-4">
            <span className="cursor-not-allowed inline-flex items-center gap-2 bg-[#6c63ff] hover:bg-[#5a52d5] px-8 py-4 rounded-full text-white font-medium transition-all transform hover:scale-105 text-lg">
              Coming Soon <Clock size={18} />
            </span>
          </div>
        </div>
