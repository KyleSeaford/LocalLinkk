      ...
      <header className="sticky top-0 z-50 bg-[#1A1A1A]/80 backdrop-blur-md">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          <a href="#home" className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold">Local<span className="text-[#6c63ff]">Linkk</span><span className="text-sm font-normal text-gray-400">.com</span></span>
          </a>
            ...
            <div className="md:w-1/2 flex justify-center">
              <div className="relative">
                ...
                <div className="relative bg-[#252525]/80 p-6 rounded-2xl shadow-2xl backdrop-blur-sm border border-[#6c63ff]/20">
                  <img 
                    src="http://locallinkk.com/icon.png" 
